...
<html>
    <head>
        ...
        <link href="css/soutien.css" type="text/css" rel="stylesheet">
    </head>
    <body>
        <!-- ******************************** HEADER ******************************** -->
        <!-- ************************************************************************ -->
                    ...
                    <div class="col-md-11" id="contenu">
                        ...
                        <div class="col-md-12 nom">
                            ...
                            <p class="text-right modifier">
                                <a href="modifierSoutien.php?lien=<?php echo $data['Lien :'];?>" class="text-right">
                            ...
                            <div clas="row">
                                <div class="col-md-7">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                                $Select = "SELECT `Possesseur :` FROM `passifs` WHERE `Nom :`='$nom'";
                        ...
                        <div class="col-md-3 col-md-offset-1 text-center" id="soutien">
                            <div class="row">
                                <!-- *************** NOM *************** -->
                                <div class="col-md-12 nomSoutien">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 effetSoutien">
                            ...
                            <div class="row ligneP">
                                ...
                                <div class="col-md-4 coutPASoutien ligne">
                            ...
                            <div class="row ligneP">
                                ...
                                <div class="col-md-4 coutTransmissionSoutien ligne">
                            ...
                            <div class="row ligneP">
                                ...
                                <div class="col-md-4 restrictionSoutien ligne">
