<?php
	if (!empty($_POST)) {
		...
		$sql = "INSERT INTO `aptitudes_spéciales_modification` 
											...
											<div class="col-md-4">
												...
												<select name="compteur">
													<?php
														...
														$i = 0;
														while ($menu = mysqli_fetch_assoc($Compteur)) {
                                                            $selected = ($data['ID_Compteur :'] == $menu['ID_Compteur :']) ? 'selected' : '';
                                                            ?>
                                                            <option value="<?php echo $menu['ID_Compteur :']; ?>"<?php echo $selected ?>>
                                                                <?php echo $menu['Compteur :']; ?>
                                                            </option>
                                                            <?php $i++;
                                                        }
													?>
