<?php
	if (!empty($_POST)) {
		...
		$sql = "INSERT INTO `soutiens_ajout` 
...
<html>
	<head>
		<meta charset="utf-8" />
		<title>Ajouter un Soutien </title>
    			...
    			<div class="row">
    				...
    				<div class="col-md-11" id="contenu">
	    				...
	    				<div class="row">
	    					<div class="col-md-12">
								<div id="container">
									<h1>Ajouter une Aptitude de Soutien</h1>
									<form action="ajouterSoutien.php" method="post" accept-charset="utf-8">
										<div class="row">
											<div class="col-md-4">
