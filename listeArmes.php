...
<html>
	<head>
		<meta charset="utf-8">
		<title>Liste Armes</title>

		<!-- CSS Bootstrap -->
	    <link href="css/bootstrap.css" type="text/css" rel="stylesheet">
	    <!-- CSS Perso' -->
	    <link href="css/general.css" type="text/css" rel="stylesheet">
        <link href="css/listeArmes.css" type="text/css" rel="stylesheet">
	</head>
	<body>
		<!-- ******************************** HEADER ******************************** -->
    	<!-- ************************************************************************ -->
    			...
    			<div class="row">
    				...
    				<div class="col-md-11" id="contenu">
    					<div class="row">
    						...
    						<div class="col-md-12 tableauArmes">
    							<!-- GENERATION LISTE EN PHP -->
                                <h2>Épées :</h2>
                                <hr/>
                                <div class="row" id="épée">
                                    <div class="col-md-12">
                                        <div class="row text-center">
                                            <div class="col-md-2 armeMenu">
                                                <p>Nom :</p>
                                            </div> <!-- ./end div.col-md-2.armeMenu -->
                                            <div class="col-md-2 armeMenu">
                                                <p>Dommage (Dmg) :</p>
                                            </div> <!-- ./end div.col-md-2.armeMenu -->
                                            <div class="col-md-2 armeMenu">
                                            ...
                                            <div class="col-md-6 armeMenu">
                                                <p>Effet :</p>
                                            </div> <!-- ./end div.col-md-6.armeMenu -->
                                        </div>
                                        <?php
                                            $armes = "SELECT * FROM armes 
                                            LEFT JOIN `armes_effet` ON `armes_effet`.`ID_Effet :` = `armes`.`Effet :`
                                            WHERE `Type :` = '1'
                                            ORDER BY `Nom :`";
                                            $listeArmes = mysqli_query($link, $armes);
                                            $i = 0;

                                            while ($data = mysqli_fetch_assoc($listeArmes)) {?>
                                                <div class="row text-center ligneP">
                                                    <div class="col-md-2 arme ligne">
                                                        <a href="arme.php?lien=<?php echo $data['Lien :'];?>"><?php echo $data['Nom :'] ?></a href="armes.php">
                                                    </div> <!-- ./end div.col-md-2.arme -->
                                                    <div class="col-md-2 arme ligne">
                                                    ...
                                                    <div class="col-md-6 arme ligne">
                                                        <p><?php echo $data['Effet :']; ?></p>
                                                    </div> <!-- ./end div.col-md-6.arme -->
                                                </div> <!-- ./end div.row -->
                                                <?php $i++;
                                            }
                                        ?>
                                    </div> <!-- ./end div.col-md-12 -->
                                </div> <!-- ./end div.row #épée -->
                                <h3>Lances :</h3>
                                <hr/>
                                ...
                                </div> <!-- ./end div.row #lance -->
    						</div> <!-- ./end div.col-md-12 -->
    					</div> <!-- ./end div.row -->
    				</div> <!-- ./end div.col-md-11 #contenu -->
    			</div> <!-- ./end div.row -->
    		</div> <!-- ./end div.container-fluid -->
    	</section> <!-- ./end section.listeArmes -->
        <!-- ******************************** FOOTER ******************************** -->
        <!-- ************************************************************************ -->
